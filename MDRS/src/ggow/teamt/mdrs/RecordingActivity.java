...
LocationListener {
	...
	private void createAudioPath() throws IOException {
		AudioPath = String.valueOf(System.currentTimeMillis()) + "/audio.3gp";
		sanitisePath(AudioPath);
		Log.v(LOG_TAG,"Audio Path is" + AudioPath);
		if (checkDirectory()){
			Log.v(LOG_TAG,"Directories checked. All good");
		}
	}
